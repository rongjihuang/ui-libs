...
*/
(function(){var n=Highcharts,z=n.Chart,C=n.addEvent,t=n.createElement,A=n.discardElement,u=n.css,w=n.merge,p=n.each,q=n.extend,D=Math.max,s=document,E=window,B=s.documentElement.ontouchstart!==undefined,x=n.getOptions();q(x.lang,{downloadPNG:"导出为 PNG 图",downloadJPEG:"导出为 JPEG 图",downloadPDF:"导出为 PDF 文档",downloadSVG:"导出为 SVG 向量图",exportButtonTitle:"导出",printButtonTitle:"打印"});x.navigation={menuStyle:{border:"1px solid #A0A0A0",
